...
async def start(event):
  await event.reply("**Tr Tagger RoBot 🇹🇷**, Grup veya kanaldaki neredeyse tüm üyelerden bahsedebilir ★\nDaha fazla bilgi için **/help**'i tıklayın.",
                    buttons=(
                      [Button.url('🌟 Beni Bir Gruba Ekle', 'http://t.me/TrTaggerRoBot?startgroup=a'),
                      Button.url('📣 Support', 'https://t.me/lyuksmekan'),
                      Button.url('👮‍♂️ Sahibim', 'https://t.me/Vusaldidaa')]
                    ),
                    link_preview=False
                   )
@client.on(events.NewMessage(pattern="^/help$"))
async def help(event):
  helptext = "**Tr Tagger RoBot 🇹🇷'un Yardım Menüsü**\n\nKomut: /all \n  Bu komutu, başkalarına bahsetmek istediğiniz metinle birlikte kullanabilirsiniz. \n`Örnek: /all Günaydın!`  \nBu komutu yanıt olarak kullanabilirsiniz. herhangi bir mesaj Bot, yanıtlanan iletiye kullanıcıları etiketleyerek ve /bitir yazarak etiketleme işlemi biter. 🤗"
...
print(">> Bot çalıyor merak etme 👮‍♂️ @Vusaldidaa bilgi alabilirsin <<")
